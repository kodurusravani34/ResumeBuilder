  ...
  return (
    <div>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={addProject} className='flex items-center gap-2 px-3 py-1 text-sm bg-red-100 text-red-700 rounded-lg hover:bg-orange-200 transition-colors'>
