...
import { Briefcase, Trash2, Sparkles, Loader2 } from 'lucide-react'
    ...
    return (
        <div className='space-y-6'>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm bg-red-100 text-red-700 rounded-lg hover:bg-orange-200 transition-colors'>
                        ...
                        space-y-3">
                            ...
                            <div className="space-y-2">
                              <div className='flex items-center justify-between'>
                                ...
                                position || !experience.company} className='flex items-center gap-1 px-2 py-1
